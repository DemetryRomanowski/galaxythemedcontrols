...
{
    public class RadioButtonThemeSelector : UITypeEditor
    {
        ...
        public override Object EditValue(ITypeDescriptorContext context, IServiceProvider provider, Object value)
        {
            ...
            if (context != null)
            {
                GalaxyRadioButton button = (GalaxyRadioButton)context.Instance;
                foreach (IRadioButtonTheme th in button.ColorThemes)
                {
